      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-yellow-900/30 border border-yellow-700 rounded-lg p-4">
          <p className="text-yellow-100">
            تم تعطيل وحدة الفحص الشامل مؤقتاً لأن ملف الاختبارات كان غير متوافق مع نماذج البيانات الحالية.
            يمكن إعادة تفعيلها بعد توحيد الـtypes وتحديث سيناريوهات الاختبار.
          </p>
        </div>
      </div>
    </div>
