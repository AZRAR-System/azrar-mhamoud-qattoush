    ...
    <div className="h-full flex flex-col">
      ...
      <div className="app-card p-6 mb-4 print:hidden">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <ChevronDown className="absolute left-3 top-3.5 text-gray-500 pointer-events-none" size={16} />
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 bg-white border border-gray-200 rounded-xl p-8 overflow-y-auto shadow-inner relative text-black print:shadow-none print:border-none print:w-full">
        ...
        <div className="hidden print:block mt-12 pt-8 border-t border-gray-300">
            ...
            <p className="text-center text-xs mt-4">تم إنشاء هذا المستند إلكترونياً عبر نظام خبرني للخدمات العقارية</p>
            <p className="text-center text-xs mt-2 whitespace-pre-line">{getOfficialBrandSignature()}</p>
        </div>
      </div>
