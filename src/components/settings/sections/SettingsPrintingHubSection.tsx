...
export function SettingsPrintingHubSection({ page }: Props) {
  ...
  return (
    <RBACGuard requiredPermission="SETTINGS_ADMIN" fallback={settingsNoAccessFallback}>
      <div className="p-6 lg:p-8 overflow-y-auto custom-scrollbar h-full animate-fade-in">
        <div className="mb-8">
          <div className="flex flex-wrap items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
                كل إعدادات الطباعة، الترويسة، قوالب Word/DOCX، والمتغيرات في صفحة واحدة مع
                معاينة فورية.
              </p>
            </div>
          </div>
        ...
        {settings ? (
          <PrintingHubKpiCards
            ...
            contractVariablesCount={CONTRACT_WORD_TEMPLATE_VARIABLES.length}
