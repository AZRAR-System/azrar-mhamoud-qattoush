...
interface SystemSetupPageViewProps {
  page: UseSystemSetupReturn;
}

export const SystemSetupPageView: React.FC<SystemSetupPageViewProps> = ({ page }) => {
  const {
              ...
              <div className="flex-1 overflow-y-auto space-y-2.5 custom-scrollbar pr-2 scroll-smooth">
                ...
                {logs.map((log, i) => (
                  <div key={i} className="flex gap-4 text-rtl animate-in fade-in slide-in-from-right-1 duration-200">
                    <span className="text-slate-700 shrink-0 text-[10px] tabular-nums font-black mt-1.5 opacity-50">
