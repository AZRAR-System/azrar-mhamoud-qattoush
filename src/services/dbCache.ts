...
import { الأشخاص_tbl, العقارات_tbl, العقود_tbl, الكمبيالات_tbl, شخص_دور_tbl, العمولات_tbl, المستخدمين_tbl, مستخدم_صلاحية_tbl, tbl_Alerts, عروض_البيع_tbl, عروض_الشراء_tbl, اتفاقيات_البيع_tbl, تذاكر_الصيانة_tbl, سجل_الملكية_tbl } from '../types';
...
export function buildCache() {
  ...
  DbCache.dashboardStats.topDebtors = topDebtorsList.sort((a, b) => b.amount - a.amount).slice(0, 5);
