...
export const PropertySchema = z.object({
  ...
  الإيجار_التقديري: z.number().optional(),
  IsRented: z.boolean(),
  المساحة: z.number(),
...
export const ContractSchema = z.object({
  ...
  القيمة_السنوية: z.number(),
  تكرار_الدفع: z.number(),
  طريقة_الدفع: z.string(),
  قيمة_التأمين: z.number().optional(),
  يوجد_دفعة_اولى: z.boolean().optional(),
  قيمة_الدفعة_الاولى: z.number().optional(),
  عدد_أشهر_الدفعة_الأولى: z.number().optional(),
  تقسيط_الدفعة_الأولى: z.boolean().optional(),
  عدد_أقساط_الدفعة_الأولى: z.number().optional(),
  احتساب_فرق_ايام: z.boolean().optional(),
  يوم_الدفع: z.number().optional(),
  مبلغ_الفرقية: z.number().optional(),
  حالة_العقد: z.string(),
  ...
  lateFeeValue: z.number(),
  lateFeeGraceDays: z.number(),
  lateFeeMaxAmount: z.number().optional(),
  حقول_ديناميكية: DynamicFieldsSchema,
});
...
export const InstallmentSchema = z.object({
  ...
  القيمة: z.number(),
  القيمة_المتبقية: z.number().optional(),
